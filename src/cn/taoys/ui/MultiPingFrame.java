...
public class MultiPingFrame extends JFrame{
	...
	private static Logger logger = Logger.getLogger(MultiPingFrame.class);
	...
	public MultiPingFrame()  {
	}

	public MultiPingFrame(EntityContext context){
		init();
	...
	private void init() {
		...
		addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e){
				clientContext.exit(MultiPingFrame.this);
			}
		});
	...
	private JPanel createBackBtnPane() {
		...
		backMenu.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				clientContext.backMenu(MultiPingFrame.this);
			}
		});
...
//				clientContext.stopPing();
	...
	public static void main(String[] args) {
		...
		MultiPingFrame multiPingFrame = new MultiPingFrame(context);
		ClientContext clientContext = new ClientContext();
//		NetworkService networkService= new NetworkService();
		LoginFrame loginFrame = new LoginFrame();
		
		clientContext.setMultiPingFrame(multiPingFrame);
		clientContext.setLoginFrame(loginFrame);
		multiPingFrame.setClientContext(clientContext);
		
		multiPingFrame.setVisible(true);
		
		System.out.println("netaddress="+multiPingFrame.getNetAddress());
	}
}
